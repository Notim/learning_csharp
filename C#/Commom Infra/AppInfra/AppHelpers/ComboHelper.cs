...
namespace WEB.AppHelpers {
    ...
    public class ComboHelper {
        ...
        public static SelectList selectListTrueFalse(bool? selected, string textoYes = "Sim", string textNo = "Não") {

            textoYes = textoYes.isEmpty() ? "Sim" : textoYes;
            textNo = textNo.isEmpty() ? "Não" : textNo;
            
            var list = new[] {
                new{value = true, text = textoYes},
                new{value = false, text = textNo}
            };
            return new SelectList(list, "value", "text", selected);
        }
        ...
        public static SelectList selectListNroRegistros(string selected) {
            var list = new[] {
                    ...
                    new{value = "30", text = "30 registros"},
