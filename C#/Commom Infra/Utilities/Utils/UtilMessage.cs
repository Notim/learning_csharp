...
namespace UTIL.Utils {
    ...
    public static class UtilMessage {
        ...
        private const string MESSAGE_ERROR_FACEDOWN   = "<div class='pull-left' style='font-size:3.5em;margin-right:15px;'><i class=\"icon fal fa-frown\"></i></div><div><h4 class='text-black'> {0}</h4>{1}</div><div class='clearfix'></div>";
