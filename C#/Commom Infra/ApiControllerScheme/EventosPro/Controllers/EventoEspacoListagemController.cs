...
namespace WEB.Areas.Api.EventosPro.Controllers{
    ...
    [AcessoComToken, Route("Api/EventosPro/EventoEspacoListagem")]
    public class EventoEspacoListagemController : ApiController{

        [HttpGet]
        public HttpResponseMessage Get(int idEvento) {
            
            var ORetorno = new DefaultDTO();
            var ViewModel = new EventoEspacoListagemVM();
