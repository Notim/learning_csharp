...
namespace WEB.Areas.Api.EventosPro.Controllers {
    ...
    [AcessoComToken, Route("Api/EventosPro/EventoExpositorListagem")]
    public class EventoExpositorListagemController : ApiController {

        [HttpGet]
        public HttpResponseMessage Get(int idEvento){

            var ORetorno = new DefaultDTO();
            var ViewModel = new EventoExpositorListagemVM();
