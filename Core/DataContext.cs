...
namespace DAL.Repository.Base {
    ...
    public partial class DataContext : DbContext {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder) {
            ...
            this.mapperModuloTarefas(modelBuilder);
            ...
            this.mapperModuloArquivosEDI(modelBuilder);

            this.mapperModuloCompras(modelBuilder);

            this.mapperModuloCheckout(modelBuilder);
            ...
            this.mapperModuloImportacoes(modelBuilder);
            ...
            this.mapperModuloConfiguracoesApp(modelBuilder);
            ...
            this.mapperModuloConfiguracoesCheckout(modelBuilder);

            this.mapperModuloConfiguracoesCarteirinha(modelBuilder);

            this.mapperModuloConfiguracoesMeioPagamento(modelBuilder);

            this.mapperModuloConfiguracoesPagarme(modelBuilder);

            this.mapperModuloConfiguracoesBoleto(modelBuilder);

            this.mapperModuloConfiguracoesRecibo(modelBuilder);

            this.mapperModuloConfiguracoesCartaoCredito(modelBuilder);
            ...
            this.mapperModuloComissoesAvaliacao(modelBuilder);

            this.mapperModuloRelatoriosAssociados(modelBuilder);

            this.mapperModuloTipos(modelBuilder);

            this.mapperModuloAssociadosContribuicoesBoletos(modelBuilder);

            this.mapperModuloAssociadosInadimplencia(modelBuilder);
            ...
            this.mapperModuloConfiguracoesPostback(modelBuilder);
            ...
            this.mapperModuloTarefasPessoais(modelBuilder);
